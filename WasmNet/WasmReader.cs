    ...
    public partial class WasmReader {
        ...
        public BaseOpcode ReadOpcode() {
            ...
            switch (type) {
                ...
                case WasmOpcodeType.I32Load: return new I32LoadOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Load: return new I64LoadOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.F32Load: return new F32LoadOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.F64Load: return new F64LoadOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I32Load8S: return new I32Load8SOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I32Load8U: return new I32Load8UOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I32Load16S: return new I32Load16SOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I32Load16U: return new I32Load16UOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Load8S: return new I64Load8SOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Load8U: return new I64Load8UOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Load16S: return new I64Load16SOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Load16U: return new I64Load16UOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Load32S: return new I64Load32SOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Load32U: return new I64Load32UOpcode { Immediate = ReadMemoryImmediate() };

                case WasmOpcodeType.I32Store: return new I32StoreOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Store: return new I64StoreOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.F32Store: return new F32StoreOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.F64Store: return new F64StoreOpcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I32Store8: return new I32Store8Opcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I32Store16: return new I32Store16Opcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Store8: return new I64Store8Opcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Store16: return new I64Store16Opcode { Immediate = ReadMemoryImmediate() };
                case WasmOpcodeType.I64Store32: return new I64Store32Opcode { Immediate = ReadMemoryImmediate() };
